...
class CustomizeUI: Feature("Customize UI", loadParams = FeatureLoadParams.ACTIVITY_CREATE_SYNC) {
    ...
    override fun onActivityCreate() {
        ...
        val effectivePendingSendingTextColor = colorsConfig.pendingSendingTextColorgetNullable()
        val effectiveSnapWithSoundTextColor = colorsConfig.snapWithSoundTextColor.Nullable()
        val effectiveSnapWithoutSoundTextColor = colorsConfig.snapWithoutSoundTextColor.Nullable()
        val effectiveBackgroundColor = colorsConfig.backgroundColor.Nullable()
        val effectiveBackgroundColorSurface = colorsConfig.backgroundColorSurface.Nullable()
        val effectiveActionMenuBackgroundColor = colorsConfig.actionMenuBackgroundColor.Nullable()
        val effectiveActionMenuRoundBackgroundColor = colorsConfig.actionMenuRoundBackgroundColor.Nullable()
        val effectiveCameraGridLines = colorsConfig.cameraGridLinesget.Nullable()
